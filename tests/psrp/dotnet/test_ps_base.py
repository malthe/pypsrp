...
def test_ps_object_shadowed_property():
    ...
    actual = ElementTree.tostring(element, encoding="utf-8").decode()
    assert (
        actual == '<Obj RefId="0"><TN RefId="0"><T>MyPSShadowedObject</T></TN>'
...
def test_ps_object_optional():
    ...
    actual = ElementTree.tostring(element, encoding="utf-8").decode()
    assert (
        actual == '<Obj RefId="0"><TN RefId="0"><T>OptionalPSObject</T></TN>'
        "<MS>"
        '<Nil N="NoDefault" />'
...
def test_ps_object_mandatory():
    ...
    actual = ElementTree.tostring(element, encoding="utf-8").decode()
    assert (
        actual == '<Obj RefId="0"><TN RefId="0"><T>MandatoryPSObject</T></TN>'
...
def test_ps_generic_object():
    ...
    element = serialize(obj)
    actual = ElementTree.tostring(element, encoding="utf-8").decode()
    assert actual == '<Obj RefId="0">' '<TN RefId="0"><T>MyGenericObject`1[[System.Object]]</T></TN>' "</Obj>"
